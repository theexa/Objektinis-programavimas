...
void SkaitytiIsFailo(const string& failoVardas, list<Studentas>& Grupe) {
...
void SkaidytiStudentus(const list<Studentas>& Grupe, list<Studentas>& Nuskriaustukai, list<Studentas>& Kietuoliai) {
...
void IrasytiIFaila(const string& failoVardas, const list<Studentas>& Grupe){
